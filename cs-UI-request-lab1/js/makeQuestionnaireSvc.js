//This is the current service to make Questionnaires
//It is separate to the LIM !!!
//It started as a copy of makeQ.svc which is used by the LIM and intended for the 'fully hierarchical'
//Q where the structure of the Q matches that of the DG & Comp


angular.module("pocApp")

    .service('makeQuestionnaireSvc', function($http,codedOptionsSvc,QutilitiesSvc,snapshotSvc,$filter,vsSvc) {
...
*/
        ...
        return {
            ...
            makeHierarchicalQFromComp:  function generateQ(allElements,hashAllDG) {
                let that = this
                console.log('generate Q')
                let qName = allElements[0].ed.path
                let id = "cs-" + qName
                let Q = {resourceType: "Questionnaire", id: id, status: "draft", name: qName, item: []}
                ...
                allElements.forEach(function (item) {
                    ...
                    switch (ar.length) {
                        ...
                        case 3 :
                            ...
                            that.makeHierarchicalQFromDG(allDgElements,hashAllDG,function (Q) {
                                sectionItem.item = Q.item[0].item  //note they are both arrays
                            })


                           // let vo = that.makeHierarchicalQFromDG(allDgElements,hashAllDG)
            ...
            makeHierarchicalQFromDG : function (lstElements,hashAllDG,cb) {
                ...
                function generateQ() {
                    ...
                    for (const item of lstElements) {
                        ...
                        if (currentItem) {
                            ...
                            makeAnswerOption(currentItem,ed)

                            //let i = hashItems[parentItemPath]
                ...
                function makeAnswerOption(item,ed) {
                    if (ed.valueSet) {
                        console.log(ed.valueSet)
                        console.log(vsSvc.getOneVS(ed.valueSet))
                        let lstConcepts = vsSvc.getOneVS(ed.valueSet)
                        if (lstConcepts && lstConcepts.length > 0) {
                            item.type = 'choice'
                            item.answerOption = []
            ...
            //this is a copy from the LIM version
            makeQFromDGNOTUSED : function (lstElements,hashAllDG) {
            ...
            makeTreeFromQNOTUSED : function (Q) {
