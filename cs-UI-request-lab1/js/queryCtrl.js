...
*/
            ...
            $scope.expandVSFromCMDEP = function (code) {
            ...
            $scope.performTranslateDEP = function () {
            ...
            $scope.generateTranslateQueryDEP = function() {
            ...
            $scope.expandFromAnalysisVSDEP = function (url) {
            ...
            $scope.expandFromAnalysisDEP = function (url) {
            ...
            $scope.executeFromLibraryDEP = function (item) {
            ...
            $scope.executeFromHistoryDEP = function (qry) {
            ...
            $scope.removeHistoryDEP = function (inx) {
                $localStorage.genHistory.splice(inx,1)
            }

            $scope.trimDisplayDEP = function(str,length) {
                if (str) {
            ...
            $scope.executeGeneralQueryDEP = function (qry) {
            ...
            $scope.findVSDEP = function (type,tumourType,custom) {
                delete $scope.selectedVS
                delete $scope.oo
