...
export declare function loadAutomaticDependencies(fhirVersion: string, configuredDependencies: ImplementationGuideDependsOn[], defs: BaseFHIRDefinitions): Promise<void>;
