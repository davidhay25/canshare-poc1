...
exports.checkSushiVersion = exports.getLatestSushiVersion = exports.getLocalSushiVersion = exports.getFilesRecursive = exports.init = exports.writePreprocessedFSH = exports.writeFSHIndex = exports.writeFHIRResources = exports.checkNullValuesOnArray = exports.fillTank = exports.getRawFSHes = exports.loadAutomaticDependencies = exports.loadExternalDependencies = exports.updateExternalDependencies = exports.readConfig = exports.ensureOutputDir = exports.findInputDir = exports.hasFshFiles = exports.ensureInputDir = exports.isSupportedFHIRVersion = exports.AUTOMATIC_DEPENDENCIES = void 0;
...
function loadExternalDependencies(defs, config) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield loadAutomaticDependencies(fhirVersionInfo.version, dependencies, defs);
        // Then load configured dependencies, with FHIR core last so it has highest priority in resolution
        yield loadConfiguredDependencies(dependencies, fhirVersionInfo.version, config.filePath, defs);
    });
}
