...
class StructureDefinitionExporter {
    ...
    exportStructDef(fshDefinition) {
        ...
        this.pkg.fshMap.set(structDef.getFileName(), Object.assign(Object.assign({}, fshDefinition.sourceInfo), { fshName: fshDefinition.name, fshType: fshDefinition.constructorName }));
