...
class ValueSetExporter {
    ...
    setConceptCaretRules(vs, rules) {
        ...
        for (const rule of rules) {
            ...
            const systemMeta = this.fisher.fishForMetadata(system, utils_1.Type.CodeSystem);
            let composeIndex = (_c = (_b = (_a = vs.compose) === null || _a === void 0 ? void 0 : _a.include) === null || _b === void 0 ? void 0 : _b.findIndex(composeElement => {
                return composeElement.system === system || composeElement.system === (systemMeta === null || systemMeta === void 0 ? void 0 : systemMeta.url);
            })) !== null && _c !== void 0 ? _c : -1;
            let composeArray;
            let composeElement;
            let conceptIndex = -1;
    ...
    exportValueSet(fshDefinition) {
        ...
        this.pkg.fshMap.set(vs.getFileName(), Object.assign(Object.assign({}, fshDefinition.sourceInfo), { fshName: fshDefinition.name, fshType: 'ValueSet' }));
        return vs;
    }
}
