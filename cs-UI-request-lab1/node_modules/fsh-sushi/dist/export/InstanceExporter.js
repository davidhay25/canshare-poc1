...
class InstanceExporter {
    ...
    exportInstance(fshDefinition) {
        ...
        if (fshDefinition.usage !== 'Inline') {
            this.pkg.fshMap.set(instanceDef.getFileName(), Object.assign(Object.assign({}, fshDefinition.sourceInfo), { fshName: fshDefinition.name, fshType: fshDefinition.constructorName }));
        }
